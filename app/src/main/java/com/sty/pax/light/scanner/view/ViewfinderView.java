package com.sty.pax.light.scanner.view;
...
public class ViewfinderView extends View {
    ...
    private Rect getFramingRect(){
        Point screenWH = ScreenMetricUtils.getPrintScreenPixel(MyApplication.getmApp());
        ...
        Log.i("Test", "left:" + left + " top:" + top + " right:" + right + " bottom:" + bottom);
        Log.i("Test", "screenWH.x:" + screenWH.x + "/ screenWH.y:" + screenWH.y);
